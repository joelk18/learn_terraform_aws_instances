...
def lambda_handler(event, context):
    ...
    cursor.execute("""INSERT INTO employees (employeeNumber, lastName, firstName, extension, email, officeCode, reportsTo, jobTitle)
VALUES
...
(496,'Kelly\'s Gift Shop','Snowden','Tony','+64 9 5555500','Arenales 1938 3\'A\'',NULL,'Auckland  ',NULL,NULL,'New Zealand',1612,'110000.00');""")
    ...
    cursor.execute("""insert  into employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values 
...
""")
    cursor.execute("""insert  into offices(officeCode,city,phone,addressLine1,addressLine2,state,country,postalCode,territory) values 
...
""")
    ...
    cursor.execute("""insert  into `orderdetails`(`orderNumber`,`productCode`,`quantityOrdered`,`priceEach`,`orderLineNumber`) values 
...
(10425,'S50_1392',18,'94.92',2);""")
    ...
    cursor.execute("""insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values 
...
""")
    ...
    cursor.execute("""insert  into payments(customerNumber,checkNumber,paymentDate,amount) values 
...
(496,'MN89921','2004-12-31','52166.00');""")
    ...
    cursor.execute("""insert  into productlines (productLine,textDescription,htmlDescription,image) values 
...
""")
    ...
    cursor.execute("""insert  into `products`(`productCode`,`productName`,`productLine`,`productScale`,`productVendor`,`productDescription`,`quantityInStock`,`buyPrice`,`MSRP`) values 
